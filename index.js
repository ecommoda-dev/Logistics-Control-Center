...
// skills: worker-builder v3.8.0 · dashboard-builder v2.1.0 · order-lifecycle v1.1.0 · constants v3.1.0 — 24-09-2026
//
...
// الـ commit. الأداة دي بتكتب type فقط تحت اسمها هي (login · logout) —
// مفيش سجل مشترك (metafields_change) ولا appId هنا.
const LOG_REGISTRY = {
  logistics_control_center: new Set(['login', 'logout']),
};
...
async function writeLog(db, entry) {
  // الحارس الديناميكي (§LOG-REG · worker-builder Step 7-ج) — بيراقب مايحكمش.
  // قيمة (tool,type) مش في LOG_REGISTRY بتتكتب عادي + علامة _unregistered،
